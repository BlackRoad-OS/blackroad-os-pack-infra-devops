...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-pack-infra-devops.git
cd blackroad-os-pack-infra-devops

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-pack-infra-devops.git
