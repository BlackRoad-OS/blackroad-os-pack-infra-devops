...
# ulackroad os pack infra devops
...
**ulackroad os pack infra devops** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
git clone https://github.com/BlackRoad-OS/blackroad-os-pack-infra-devops.git
cd blackroad-os-pack-infra-devops
...
│                    │                           │
│            ┌───────────────┐                   │
│            │  blackroad-os-pack-infra-devops  │  ◀── You are here │
│            └───────────────┘                   │
└─────────────────────────────────────────────────┘
```
